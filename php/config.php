...
/*	*	*	 SETUP	*	*	 */
	...
	$nav = array(
				'Inicio',
				'Carrocerías|Mudanceras|Cajas Secas|Tipo Jaulas|Tipo Gaseras|Plataformas|Furgón|Otros diseños',
				'Almacenaje|Selectivo|Double Deep|Cantilever|Push Back|Carton Flow|Mezzanine|Estantería|Entrepiso|Otros',
				'Servicios|Mantenimiento Preventivo|Mantenimiento Correctivo|Montaje|Desmontaje y Traslados|Consultoría',
				'Más|Productos para Construcción|Instalación de Elevadores|Recursos Humanos|Energía Eléctrica|Personalización',
				'Contacto'
				);
	$navigation="";
	...
	function cLinks($name, $class='',$inner=null){
		...
		if($inner){
			return '<a href="'.cname($inner.".html#_".$name).'" class="'.active(cname($name)).$cl.'">'.$name.'</a>';
		} else {
